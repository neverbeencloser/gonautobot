...
// NewExtrasCustomFieldChoicesUpdateParams creates a new ExtrasCustomFieldChoicesUpdateParams object,
...
func NewExtrasCustomFieldChoicesUpdateParams() *ExtrasCustomFieldChoicesUpdateParams {
	return &ExtrasCustomFieldChoicesUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewExtrasCustomFieldChoicesUpdateParamsWithTimeout creates a new ExtrasCustomFieldChoicesUpdateParams object
...
// NewExtrasCustomFieldChoicesUpdateParamsWithContext creates a new ExtrasCustomFieldChoicesUpdateParams object
...
// NewExtrasCustomFieldChoicesUpdateParamsWithHTTPClient creates a new ExtrasCustomFieldChoicesUpdateParams object
...
/* ExtrasCustomFieldChoicesUpdateParams contains all the parameters to send to the API endpoint
   for the extras custom field choices update operation.
...
// WithDefaults hydrates default values in the extras custom field choices update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExtrasCustomFieldChoicesUpdateParams) WithDefaults() *ExtrasCustomFieldChoicesUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the extras custom field choices update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExtrasCustomFieldChoicesUpdateParams) SetDefaults() {
