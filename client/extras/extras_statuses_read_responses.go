...
func (o *ExtrasStatusesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewExtrasStatusesReadOK()
...
func NewExtrasStatusesReadOK() *ExtrasStatusesReadOK {
	return &ExtrasStatusesReadOK{}
}

/* ExtrasStatusesReadOK describes a response with status code 200, with default header values.
...
func (o *ExtrasStatusesReadOK) Error() string {
	return fmt.Sprintf("[GET /extras/statuses/{id}/][%d] extrasStatusesReadOK  %+v", 200, o.Payload)
}
func (o *ExtrasStatusesReadOK) GetPayload() *models.Status {
	return o.Payload
}

func (o *ExtrasStatusesReadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
