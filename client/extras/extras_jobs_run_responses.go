...
func (o *ExtrasJobsRunReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewExtrasJobsRunCreated()
...
func NewExtrasJobsRunCreated() *ExtrasJobsRunCreated {
	return &ExtrasJobsRunCreated{}
}

/* ExtrasJobsRunCreated describes a response with status code 201, with default header values.
...
func (o *ExtrasJobsRunCreated) Error() string {
	return fmt.Sprintf("[POST /extras/jobs/{class_path}/run/][%d] extrasJobsRunCreated  %+v", 201, o.Payload)
}
func (o *ExtrasJobsRunCreated) GetPayload() *models.JobInput {
	return o.Payload
}

func (o *ExtrasJobsRunCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.JobInput)
