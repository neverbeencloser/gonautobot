...
func (o *ExtrasCustomFieldChoicesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewExtrasCustomFieldChoicesBulkPartialUpdateOK()
...
func NewExtrasCustomFieldChoicesBulkPartialUpdateOK() *ExtrasCustomFieldChoicesBulkPartialUpdateOK {
	return &ExtrasCustomFieldChoicesBulkPartialUpdateOK{}
}

/* ExtrasCustomFieldChoicesBulkPartialUpdateOK describes a response with status code 200, with default header values.
...
func (o *ExtrasCustomFieldChoicesBulkPartialUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /extras/custom-field-choices/][%d] extrasCustomFieldChoicesBulkPartialUpdateOK  %+v", 200, o.Payload)
}
func (o *ExtrasCustomFieldChoicesBulkPartialUpdateOK) GetPayload() *models.CustomFieldChoice {
	return o.Payload
}

func (o *ExtrasCustomFieldChoicesBulkPartialUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
