...
func (o *ExtrasJobResultsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewExtrasJobResultsBulkPartialUpdateOK()
...
func NewExtrasJobResultsBulkPartialUpdateOK() *ExtrasJobResultsBulkPartialUpdateOK {
	return &ExtrasJobResultsBulkPartialUpdateOK{}
}

/* ExtrasJobResultsBulkPartialUpdateOK describes a response with status code 200, with default header values.
...
func (o *ExtrasJobResultsBulkPartialUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /extras/job-results/][%d] extrasJobResultsBulkPartialUpdateOK  %+v", 200, o.Payload)
}
func (o *ExtrasJobResultsBulkPartialUpdateOK) GetPayload() *models.JobResult {
	return o.Payload
}

func (o *ExtrasJobResultsBulkPartialUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
