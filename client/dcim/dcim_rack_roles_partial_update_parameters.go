...
func (o *DcimRackRolesPartialUpdateParams) WithID(id strfmt.UUID) *DcimRackRolesPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim rack roles partial update params
func (o *DcimRackRolesPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
