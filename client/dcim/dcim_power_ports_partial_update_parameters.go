...
func (o *DcimPowerPortsPartialUpdateParams) WithID(id strfmt.UUID) *DcimPowerPortsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim power ports partial update params
func (o *DcimPowerPortsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
