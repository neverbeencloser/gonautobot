...
func (o *DcimPlatformsPartialUpdateParams) WithID(id strfmt.UUID) *DcimPlatformsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim platforms partial update params
func (o *DcimPlatformsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
