...
func (o *DcimRearPortTemplatesUpdateParams) WithID(id strfmt.UUID) *DcimRearPortTemplatesUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim rear port templates update params
func (o *DcimRearPortTemplatesUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
