...
func (o *DcimRackReservationsUpdateParams) WithID(id strfmt.UUID) *DcimRackReservationsUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim rack reservations update params
func (o *DcimRackReservationsUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
