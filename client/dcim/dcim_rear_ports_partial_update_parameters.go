...
func (o *DcimRearPortsPartialUpdateParams) WithID(id strfmt.UUID) *DcimRearPortsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim rear ports partial update params
func (o *DcimRearPortsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
