...
func (o *DcimFrontPortTemplatesUpdateParams) WithID(id strfmt.UUID) *DcimFrontPortTemplatesUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim front port templates update params
func (o *DcimFrontPortTemplatesUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
