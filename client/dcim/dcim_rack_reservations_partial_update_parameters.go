...
func (o *DcimRackReservationsPartialUpdateParams) WithID(id strfmt.UUID) *DcimRackReservationsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim rack reservations partial update params
func (o *DcimRackReservationsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
