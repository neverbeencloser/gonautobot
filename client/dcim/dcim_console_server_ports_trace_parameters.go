...
func (o *DcimConsoleServerPortsTraceParams) WithID(id strfmt.UUID) *DcimConsoleServerPortsTraceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim console server ports trace params
func (o *DcimConsoleServerPortsTraceParams) SetID(id strfmt.UUID) {
	o.ID = id
}
