...
func (o *DcimPowerOutletsPartialUpdateParams) WithID(id strfmt.UUID) *DcimPowerOutletsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim power outlets partial update params
func (o *DcimPowerOutletsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
