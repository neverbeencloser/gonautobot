...
func (o *DcimInterfacesPartialUpdateParams) WithID(id strfmt.UUID) *DcimInterfacesPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim interfaces partial update params
func (o *DcimInterfacesPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
