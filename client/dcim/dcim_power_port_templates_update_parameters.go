...
func (o *DcimPowerPortTemplatesUpdateParams) WithID(id strfmt.UUID) *DcimPowerPortTemplatesUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim power port templates update params
func (o *DcimPowerPortTemplatesUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
