...
func (o *DcimDeviceRolesPartialUpdateParams) WithID(id strfmt.UUID) *DcimDeviceRolesPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the dcim device roles partial update params
func (o *DcimDeviceRolesPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
