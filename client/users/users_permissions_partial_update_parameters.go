...
func (o *UsersPermissionsPartialUpdateParams) WithID(id strfmt.UUID) *UsersPermissionsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the users permissions partial update params
func (o *UsersPermissionsPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
