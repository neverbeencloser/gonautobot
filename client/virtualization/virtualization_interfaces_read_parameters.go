...
func (o *VirtualizationInterfacesReadParams) WithID(id strfmt.UUID) *VirtualizationInterfacesReadParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the virtualization interfaces read params
func (o *VirtualizationInterfacesReadParams) SetID(id strfmt.UUID) {
	o.ID = id
}
