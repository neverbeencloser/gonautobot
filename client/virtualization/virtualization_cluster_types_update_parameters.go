...
func (o *VirtualizationClusterTypesUpdateParams) WithID(id strfmt.UUID) *VirtualizationClusterTypesUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the virtualization cluster types update params
func (o *VirtualizationClusterTypesUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
