...
func (o *VirtualizationVirtualMachinesPartialUpdateParams) WithID(id strfmt.UUID) *VirtualizationVirtualMachinesPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the virtualization virtual machines partial update params
func (o *VirtualizationVirtualMachinesPartialUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
