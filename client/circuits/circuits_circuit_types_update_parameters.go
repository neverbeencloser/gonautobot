...
func (o *CircuitsCircuitTypesUpdateParams) WithID(id strfmt.UUID) *CircuitsCircuitTypesUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the circuits circuit types update params
func (o *CircuitsCircuitTypesUpdateParams) SetID(id strfmt.UUID) {
	o.ID = id
}
