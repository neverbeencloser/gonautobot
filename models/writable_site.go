...
type WritableSite struct {
	...
	// Region
	// Format: uuid
	Region *strfmt.UUID `json:"region,omitempty"`
...
func (m *WritableSite) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableSite) validateID(formats strfmt.Registry) error {
...
func (m *WritableSite) validateRegion(formats strfmt.Registry) error {
	if swag.IsZero(m.Region) { // not required
		return nil
	}

	if err := validate.FormatOf("region", "body", "uuid", m.Region.String(), formats); err != nil {
		return err
	}
...
func (m *WritableSite) validateTenant(formats strfmt.Registry) error {
...
func (m *WritableSite) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
