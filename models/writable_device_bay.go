...
type WritableDeviceBay struct {
	...
	// Installed device
	// Format: uuid
	InstalledDevice *strfmt.UUID `json:"installed_device,omitempty"`
...
func (m *WritableDeviceBay) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableDeviceBay) validateID(formats strfmt.Registry) error {
...
func (m *WritableDeviceBay) validateInstalledDevice(formats strfmt.Registry) error {
	if swag.IsZero(m.InstalledDevice) { // not required
		return nil
	}

	if err := validate.FormatOf("installed_device", "body", "uuid", m.InstalledDevice.String(), formats); err != nil {
		return err
	}
...
func (m *WritableDeviceBay) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
