...
type WritableConfigContext struct {
	...
	// Format: uuid
	Schema *strfmt.UUID `json:"schema,omitempty"`
...
func (m *WritableConfigContext) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableConfigContext) validateID(formats strfmt.Registry) error {
...
func (m *WritableConfigContext) validateOwnerObjectID(formats strfmt.Registry) error {
...
func (m *WritableConfigContext) validateSchema(formats strfmt.Registry) error {
	if swag.IsZero(m.Schema) { // not required
		return nil
	}

	if err := validate.FormatOf("schema", "body", "uuid", m.Schema.String(), formats); err != nil {
		return err
	}
...
func (m *WritableConfigContext) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
