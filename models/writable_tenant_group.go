...
type WritableTenantGroup struct {
	...
	// Parent
	// Format: uuid
	Parent *strfmt.UUID `json:"parent,omitempty"`
...
func (m *WritableTenantGroup) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableTenantGroup) validateID(formats strfmt.Registry) error {
...
func (m *WritableTenantGroup) validateParent(formats strfmt.Registry) error {
...
func (m *WritableTenantGroup) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
