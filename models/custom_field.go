...
func (m *CustomField) validateDisplay(formats strfmt.Registry) error {
...
const (
	...
	// CustomFieldTypeValueMultiDashSelect captures enum value "multi-select"
	CustomFieldTypeValueMultiDashSelect string = "multi-select"
)
