...
func (m *WritableCable) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableCable) validateID(formats strfmt.Registry) error {
...
func (m *WritableCable) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
