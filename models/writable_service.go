...
type WritableService struct {
	...
	// Device
	// Format: uuid
	Device *strfmt.UUID `json:"device,omitempty"`
	...
	// Virtual machine
	// Format: uuid
	VirtualMachine *strfmt.UUID `json:"virtual_machine,omitempty"`
}
...
func (m *WritableService) validateDevice(formats strfmt.Registry) error {
...
func (m *WritableService) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableService) validateID(formats strfmt.Registry) error {
...
func (m *WritableService) validateVirtualMachine(formats strfmt.Registry) error {
...
func (m *WritableService) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
