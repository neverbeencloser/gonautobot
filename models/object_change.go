...
type ObjectChange struct {
	...
	// Required: true
	// Format: uuid
	ChangedObjectID *strfmt.UUID `json:"changed_object_id"`
...
func (m *ObjectChange) validateChangedObjectID(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("changed_object_id", "body", "uuid", m.ChangedObjectID.String(), formats); err != nil {
		return err
	}
...
func (m *ObjectChange) validateID(formats strfmt.Registry) error {
