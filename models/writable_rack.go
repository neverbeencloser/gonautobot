...
func (m *WritableRack) validateDisplay(formats strfmt.Registry) error {
...
func (m *WritableRack) validateGroup(formats strfmt.Registry) error {
...
func (m *WritableRack) validateID(formats strfmt.Registry) error {
...
func (m *WritableRack) validateRole(formats strfmt.Registry) error {
...
func (m *WritableRack) validateTenant(formats strfmt.Registry) error {
...
func (m *WritableRack) contextValidateComputedFields(ctx context.Context, formats strfmt.Registry) error {
